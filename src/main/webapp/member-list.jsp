...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form  x-so search-form" action="${pageContext.request.contextPath}/searchstudentandcollegname" method="post">
            <input class="layui-input" placeholder="学院名字" name="collegname" >
            <input class="layui-input" placeholder="学生年级" name="studentclass" >
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${page.pageData}"  step="1" var="student">
            <tr>
                <td><label>
                    <input type="checkbox" class="checkedInfo" value="${student.id}">
                </label></td>
                <td>${student.id}</td>
                ...
                <td>
                    ...
                    <a title="delete" class="del"  href="${pageContext.request.contextPath}/deletedataone?del=${student.id}">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                    <a title="download" class="download"  href="${pageContext.request.contextPath}/createxcel?username=${student.username}">
                        <i class="layui-icon">&#xe642;</i>
                    </a>
                </td>
            </tr>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <li>
                    ...
                    <a href="${pageScope.request.contextPath}/studentlist?p=${page.currentPage-1}">
                        <span>&laquo</span>
                    </a>
                    </c:if>
                </li>
                <c:forEach begin="1" end="${page.pageCount}" step="1" var="p">
                    <li>
                        <a href="${pageScope.request.contextPath}/studentlist?p=${p}">${p}</a>
                    </li>
                </c:forEach>
                <li>
